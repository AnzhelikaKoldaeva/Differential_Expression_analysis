classdef HDBSCAN < handle
    ...
    methods
        ...
        function h = plot_clusters( self,varargin )
            ...
            %names_prj = {'Cell239','Cell244','Cell248','Cell251','Cell253','Cell255','Cell259',...
            %             'Cell266','Cell268','Cell271','Cell277','Cell284','Cell286','Cell287',...
            %             'Cell288','Cell302','Cell304','Cell309','Cell311','Cell317','Cell322',...
            %             'Cell324','Cell326','Cell337','Cell339','Cell343','Cell345','Cell346',...
            %             'Cell353','Cell371','Cell372','Cell389','Cell390','Cell397','Cell398',...
            %             'Cell402','Cell403','Cell406','Cell827','Cell1170','Cell2139','Cell3577','Cell6733'};
                     
            names_prj = 0:1:10744;
            names_prj = num2cell(names_prj);
            % scatter plots
            if self.nDims >= 3
                h = scatter3( self.data(:,dims(1)),self.data(:,dims(2)),self.data(:,dims(3)),'*' );
            else
                h = scatter( self.data(:,dims(1)),self.data(:,dims(2)),30,'filled');
               
                %text( self.data(:,dims(1))+0.5,self.data(:,dims(2))+0.5,names_prj,'Color','k');
                %text( self.data(:,dims(1))+0.3,self.data(:,dims(2))+0.3, names_prj_Mz_91,'Color','k');
            end
            ...
            % change appearance
            title( 'Clustered data','color',[0 0 0] );
            set( h.Parent,'tickdir','out','box','off','color','w','xcolor','k','ycolor','k' );
        end
